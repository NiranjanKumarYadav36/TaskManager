...
import { MoreVertical } from 'lucide-react'; // Import an icon for the more button
                        ...
                        loading ? (
                            ...
                            filteredTasks.length === 0 ? (
                                <div className="text-center py-12">
                                    <p className="text-gray-500">No completed tasks found with {priorityFilter !== 'all' ? priorityFilter : ''}</p>
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {renderTaskCards()}
